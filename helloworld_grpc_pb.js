...
var GreeterService = exports.GreeterService = {
  helloWorld: {
    path: '/helloworld.Greeter/helloWorld',
    requestStream: false,
  ...
  helloWorldServerStream: {
    path: '/helloworld.Greeter/helloWorldServerStream',
    requestStream: false,
    responseStream: true,
    requestType: helloworld_pb.HelloRequest,
    responseType: helloworld_pb.HelloReply,
  ...
  helloWorldClientStream: {
    path: '/helloworld.Greeter/helloWorldClientStream',
    requestStream: true,
    responseStream: false,
    requestType: helloworld_pb.HelloRequest,
    responseType: helloworld_pb.HelloReply,
  ...
  helloWorldClientAndServerStream: {
    path: '/helloworld.Greeter/helloWorldClientAndServerStream',
    requestStream: true,
    responseStream: true,
    requestType: helloworld_pb.HelloRequest,
    responseType: helloworld_pb.HelloReply,
