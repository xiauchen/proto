 ...
 *   !proto.helloworld.HelloReply>}
 */
const methodInfo_Greeter_helloWorld = new grpc.web.AbstractClientBase.MethodInfo(
  proto.helloworld.HelloReply,
  /**
   * @param {!proto.helloworld.HelloRequest} request
   * @return {!Uint8Array}
 ...
 */
proto.helloworld.GreeterClient.prototype.helloWorld =
 ...
 */
proto.helloworld.GreeterPromiseClient.prototype.helloWorld =
 ...
 *   !proto.helloworld.HelloReply>}
 */
const methodDescriptor_Greeter_helloWorldServerStream = new grpc.web.MethodDescriptor(
 ...
 *   !proto.helloworld.HelloReply>}
 */
const methodInfo_Greeter_helloWorldServerStream = new grpc.web.AbstractClientBase.MethodInfo(
  proto.helloworld.HelloReply,
  /**
   * @param {!proto.helloworld.HelloRequest} request
   * @return {!Uint8Array}
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterClient.prototype.helloWorldServerStream =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/helloworld.Greeter/helloWorldServerStream',
      request,
      metadata || {},
      methodDescriptor_Greeter_helloWorldServerStream);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.helloworld.GreeterPromiseClient.prototype.helloWorldServerStream =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/helloworld.Greeter/helloWorldServerStream',
      request,
